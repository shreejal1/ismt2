...
public class AdapterNote extends FirestoreRecyclerAdapter<Note, AdapterNote.NoteViewHolder> {
    Context context;


    public AdapterNote(@NonNull FirestoreRecyclerOptions<Note> options, Context context) {
        super(options);
